        ...
        <div class="max-w-[1444px] mx-auto px-[25px] lg:px-0 w-full h-full flex flex-col items-center justify-center">
            <div class="text-center">
                ...
                <?php if (term_description()): ?>
                    <p class="text-white/90 text-base lg:text-lg mt-4 max-w-3xl mx-auto">
    ...
    <div class="max-w-[1200px] mx-auto px-[25px] py-12 lg:py-20">
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                ...
                <h2 class="text-2xl lg:text-3xl font-extrabold text-dark mb-4">No Articles Found</h2>
                <p class="text-dark/70 mb-8">There are no posts in this archive yet.</p>
